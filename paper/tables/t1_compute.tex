...
\toprule
& \multicolumn{2}{c}{array sum ($10^6$ f64)} & \multicolumn{2}{c}{mandelbrot $200{\times}150$} & \multicolumn{2}{c}{matmul $96{\times}96$} \\
\cmidrule(lr){2-3}\cmidrule(lr){4-5}\cmidrule(lr){6-7}
implementation & ms & $\times$ & ms & $\times$ & ms & $\times$ \\
\midrule
CPython loop & 32.23 & 1.0 & 46.92 & 1.0 & 73.27 & 1.0 \\
CPython sum() & 6.25 & 5.2 & -- & -- & -- & -- \\
